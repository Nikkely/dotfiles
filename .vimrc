...
augroup fileTypeIndent
        ...
        autocmd BufNewFile,BufRead *.xslt setlocal ts=2 sts=2 sw=2
        autocmd BufNewFile,BufRead *.php setlocal ts=4 sts=4 sw=4
        autocmd BufNewFile,BufRead *.blade.php setlocal ts=2 sts=2 sw=2
